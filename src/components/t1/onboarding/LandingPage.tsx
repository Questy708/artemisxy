    ...
    <div className="min-h-screen bg-[#FDFDFD] font-sans flex flex-col text-black">
      <header className="flex justify-between items-center py-6 px-12 z-10 sticky top-0 bg-[#FDFDFD]/80 backdrop-blur-md">
        <div className="flex items-center space-x-2 cursor-pointer">
          <div className="w-6 h-6 grid grid-cols-2 gap-0.5 rotate-45 transform">
        ...
        <nav className="hidden md:flex items-center space-x-8 text-[15px] font-medium">
          <a href="#" className="hover:opacity-60 transition-opacity">Artemis Agents</a>
          <a href="#" className="hover:opacity-60 transition-opacity">Artemis Learn</a>
      ...
      <main className="flex-1 flex flex-col mt-20 px-12 pb-20">
        <div className="text-center mb-24">
          ...
          >
            Superintelligence <br /> for learning
          </motion.h1>
        </div>
        ...
        <div className="w-full max-w-[1400px] mx-auto mt-12 relative flex-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-[700px]">
            ...
            >
              <h2 className="text-[32px] font-medium mb-1">Artemis Agents</h2>
              <p className="text-[#8B939B] text-xl mb-8">AI agents for every dimension</p>
              ...
              <div className="flex space-x-3 mt-4">
                ...
                <button className="bg-[#8A0000] text-white px-6 py-3 rounded-full font-medium hover:bg-[#6B0000] transition-colors">Book an intro</button>
              </div>
              ...
              <div className="absolute bottom-10 right-10 w-[300px] bg-[#8A0000] text-white p-4 rounded-3xl rounded-br-sm shadow-xl font-medium z-10 rotate-[-5deg]">
                 Analyze today's learning activity and map insights across all six dimensions
              </div>
            </motion.div>

            {/* Artemis Learn Card (Light) */}
            <motion.div 
              initial={{ opacity: 0, scale: 0.95 }}
              animate={{ opacity: 1, scale: 1 }}
            ...
            >
              <h2 className="text-[32px] font-medium mb-1">Artemis Learn</h2>
              ...
              <div className="absolute bottom-[-20%] right-[-20%] w-full h-full bg-[#8A0000] rounded-tl-3xl opacity-80 shadow-2xl rotate-[-10deg] p-8 pb-0">
                 ...
                 <div className="flex justify-center mt-6">
                    <div className="bg-black text-white px-6 py-2 rounded-full font-medium mb-2 inline-block shadow-lg whitespace-nowrap">Learning is a continuum</div>
                 </div>
                 <div className="flex justify-center mt-2">
                    <div className="bg-black text-white px-6 py-2 rounded-full font-medium inline-block shadow-lg whitespace-nowrap mr-2">that spans...</div>
                    <div className="bg-white text-black px-6 py-2 rounded-full font-medium inline-block shadow-lg whitespace-nowrap">every dimension</div>
                 </div>
              </div>
            </motion.div>
          </div>
