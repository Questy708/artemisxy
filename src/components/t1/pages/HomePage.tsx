    ...
    <div className="w-full relative bg-white">
      ...
      <ParallaxSection section={SECTIONS[0]}>
        <div className="space-y-12">
          ...
          <div className="grid md:grid-cols-2 gap-16">
            <div className="space-y-6 text-gray-600 leading-relaxed max-w-xl text-sm md:text-base">
      ...
      <ParallaxSection section={SECTIONS[4]}>
        <div className="space-y-12">
          ...
          <div className="w-full aspect-video bg-gray-200 relative group cursor-pointer overflow-hidden border border-gray-300 max-w-5xl">
              <img
      ...
      <div id={SECTIONS[5].id} className="w-full relative shadow-[0_-15px_30px_rgba(0,0,0,0.1)]">
        <div style={{ clipPath: "inset(0 0 0 0)" }} className="relative w-full min-h-[50vh] md:min-h-[70vh] flex flex-col items-center justify-center text-center px-4 overflow-hidden bg-[#461e68]">
          ...
          <div className="relative z-10 p-6 md:p-12 w-full max-w-6xl mx-auto space-y-4">
  ...
  return (
    <div id={section.id} className="w-full relative shadow-[0_-15px_30px_rgba(0,0,0,0.15)] bg-white">
      ...
      >
        ...
        <div className="relative z-10 p-6 md:p-12 w-full max-w-6xl mx-auto space-y-4 pt-24 pb-12">
