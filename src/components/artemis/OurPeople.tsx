...
const boardOfAdvisors = [
  ...
  { title: 'Academic Standards Advisor', dept: 'Academic Quality', abbr: 'AS', desc: 'Provides external academic validation and quality assurance — ensuring that Artemis degrees meet or exceed the standards of the world\'s leading accrediting bodies.' },
  { title: 'International Law Advisor', dept: 'Legal & Regulatory', abbr: 'IL', desc: 'Advises on cross-jurisdictional legal matters, regulatory compliance across 25+ countries, and the structuring of the Artemis Collegium alliance framework.' },
  { title: 'Philanthropy & Advancement Advisor', dept: 'Advancement', abbr: 'PH', desc: 'Guides the university\'s fundraising strategy, donor stewardship, and campaign execution — drawing on deep experience in major-gift philanthropy and institutional advancement.' },
  { title: 'Technology & Innovation Advisor', dept: 'Technology', abbr: 'TI', desc: 'Advises on the digital infrastructure, AI integration, and technology strategy that underpins the synchronous global campus and the university\'s research computing capabilities.' },
  { title: 'Student & Community Representative', dept: 'Community Voice', abbr: 'SR', desc: 'Represents the student perspective on the board — ensuring that institutional decisions are informed by the lived experience of the people Artemis exists to serve.' },
  { title: 'Global Health & Equity Advisor', dept: 'Health & Equity', abbr: 'GH', desc: 'Provides strategic guidance on the university\'s commitment to global health equity, ensuring that Artemis research and education serve the communities that need them most.' },
];
